    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-100 to-blue-200 p-8 relative">
      ...
      {stage === "welcome" && (
        <div className="text-center">
          <button
            onClick={nextStage}
            className="btn px-6 py-3 bg-blue-600 text-white rounded-xl shadow hover:bg-blue-700 transition-all"
          >
            Start ▶
          </button>
        </div>
        ...
        <div className="w-full max-w-3xl relative z-0">
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center"
              ...
              {paused && !countdownActive && (
                <button
                  ...
                  className="btn px-6 py-3 bg-yellow-500 text-white rounded-xl shadow hover:bg-yellow-600 transition-all"
                >
                  ▶ Resume
                </button>
              )}
          ...
          <div className={`flex justify-between items-center mb-6 relative z-20 ${paused || countdownActive ? 'pointer-events-none opacity-60' : ''}`}>
            ...
            <Button
              ...
              className="btn px-4 py-2 bg-yellow-500 text-white rounded-xl shadow hover:bg-yellow-600 transition-all"
